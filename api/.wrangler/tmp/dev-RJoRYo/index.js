...
// .wrangler/tmp/bundle-JvAlCH/middleware-loader.entry.ts
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();

// .wrangler/tmp/bundle-JvAlCH/middleware-insertion-facade.js
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
...
// src/services/implementations/index.ts
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();

// src/services/implementations/email.cf.ts
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
...
// node_modules/mimetext/dist/mimetext.node.es.js
var t = __toESM(require_mime_types(), 1);
...
var h = { toBase64: /* @__PURE__ */ __name(function(e) {
...
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
var UMATT_LOGO = "https://umatt.ca/images/logo.png";
var WEBSITE_URL = "https://umatt.ca";
var INSTAGRAM_URL = "https://www.instagram.com/umatt_team";
var FACEBOOK_URL = "https://www.facebook.com/profile.php?id=100057560615097";
var LINKEDIN_URL = "https://www.linkedin.com/company/umatt/";
var TEAM_PAGE_URL = "https://umatt.ca/team";
var baseStyles = {
...
var templates = {
   ...
   */
  sponsorWelcome: /* @__PURE__ */ __name((data) => wrapTemplate(`
   ...
   */
  teamSponsorNotification: /* @__PURE__ */ __name((data) => wrapTemplate(`
    ...
    ${footer()}
  `), "teamSponsorNotification"),
  /**
   * Welcome email for new members
   */
  memberWelcome: /* @__PURE__ */ __name((data) => wrapTemplate(`
   ...
   */
  teamMemberNotification: /* @__PURE__ */ __name((data) => wrapTemplate(`
...
// src/services/implementations/email.cf.ts
var CFEmailService = class {
  constructor(sendEmail, fromAddress, teamEmail) {
    this.sendEmail = sendEmail;
    this.fromAddress = fromAddress;
    this.teamEmail = teamEmail;
  }
  static {
    __name(this, "CFEmailService");
  }
  async send(data) {
    const msg = u();
    msg.setSender({ name: "UMATT", addr: data.from || this.fromAddress });
  ...
  async notifyTeamNewSponsor(data) {
    await this.send({
      to: this.teamEmail,
      subject: `\u{1F389} New Sponsor Inquiry: ${data.companyName}`,
  ...
  async notifyTeamNewMember(data) {
    ...
    await this.send({
      to: this.teamEmail,
      subject: `\u{1F44B} New Member Application: ${data.name}`,
...
// src/services/implementations/storage.r2.ts
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
var R2StorageService = class {
  ...
  static {
    __name(this, "R2StorageService");
  }
  async upload(key, file, contentType2) {
  ...
  async get(key) {
    ...
    return { content, contentType: contentType2 };
  }
  async delete(key) {
   ...
   */
  static generateResumeKey(filename) {
...
// src/app.ts
function createApp(env2) {
  return {
    email: new CFEmailService(
      env2.SEND_EMAIL || null,
      // May be null in local dev
      env2.FROM_EMAIL || "noreply@umatt.ca",
      env2.TEAM_EMAIL || "umattinfo@gmail.com"
    ),
    resumeStorage: new R2StorageService(env2.RESUME_BUCKET),
    assetsStorage: new R2StorageService(env2.ASSETS_BUCKET)
  };
}
__name(createApp, "createApp");
function getAllowedOrigins(env2) {
  const origins = env2.ALLOWED_ORIGINS || "https://umatt.ca,http://localhost:5173";
  return origins.split(",").map((o2) => o2.trim());
}
...
sponsor.post("/inquiry", async (c) => {
  ...
  try {
    ...
    console.error("Error processing sponsor inquiry:", error3);
    return c.json({
      success: false,
...
member.post("/join", async (c) => {
  ...
  try {
    ...
    console.error("Error processing member application:", error3);
    return c.json({
      success: false,
